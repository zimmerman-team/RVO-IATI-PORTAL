(function () {
  ...
  function ResultsController($scope, Results, FilterSelection, templateBaseUrl, $sce) {
    ...
    vm.update = function(){
      ...
      Results.aggregation('result_indicator_title', 'activity_count,actual', "&result_indicator_period_end_year=2018" + vm.filterSelection.selectionString + programme_addition + '&indicator_period_actual_not=0&indicator_period_actual_null=False', 'result_indicator_title').then(succesFn, errorFn);
