(function () {
  ...
  function ResultsController($scope, Results, FilterSelection, templateBaseUrl, $sce) {
    ...
    vm.job_indicators = {
      ...
      'Number of full-time (equivalent) direct and indirect jobs supported - Total': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Total': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Female': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Young (15-25)': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Rural': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Urban': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Vulnerable groups': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Fragile states': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) direct jobs supported - Senior positions': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
      'Number of full-time (equivalent) indirect jobs supported - Total': {'actual': 0, 'activity_count': 0, 'parent': 'Number of jobs supported'},
    ...
    vm.coi_indicators = {
      ...
      'Amount of co-investment generated by ODA - Total': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'},
      'Amount of co-investment generated by ODA - by private sector/companies': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'},
      'Amount of co-investment generated by ODA - by private sector/financial institutions': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'},
      'Amount of co-investment generated by ODA - by donors': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'},
      'Amount of co-investment generated by ODA - by (local) government': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'},
      'Amount of co-investment generated by ODA - by NGOs and foundations': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'},
      'Amount of co-investment generated by ODA - by knowledge institutions': {'actual': 0, 'activity_count': 0, 'parent': 'Amount of co-investment generated by ODA'}, 
    ...
    vm.noc_indicators = {
      ...
      'Number of companies with supported plans to invest or trade - Total': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
      'Number of companies with supported plans to invest or trade - Dutch companies': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
      'Number of companies with supported plans to invest or trade - Local companies': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
      'Number of companies with supported plans to invest or trade - Other companies': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
      'Number of companies with supported plans to invest or trade - Local female entrepreneurs': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
      'Number of companies with supported plans to invest or trade - Local young entrepreneurs <35 years': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
      'Number of companies with supported plans to invest or trade - Local entrepreneurs from fragile states': {'actual': 0, 'activity_count': 0, 'parent': 'Number of companies with supported plans to invest or trade'},
    } //gen other, niveau 1 optellen
    ...
    */
    ...
    function activate() {
      // TO DO; this makes it impossible to use this on the programmes results tab, need to check how to implement this
