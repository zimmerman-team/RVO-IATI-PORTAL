(function () {
    ...
    angular
        ...
        .controller('ProgrammesExploreController', ProgrammesExploreController);

    ProgrammesExploreController.$inject = ['$scope', 'FilterSelection'];

    function ProgrammesExploreController($scope, FilterSelection){
        var vm = this;
